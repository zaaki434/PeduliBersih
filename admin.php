...
<br>
<center><div class="judul-berita">Permintaan Baru</div></center>
...
$sql = "SELECT p.id_permintaan, p.tgl_permintaan, u.user_nama, p.status_permintaan FROM permintaan p INNER JOIN user u ON p.user_id = u.user_id WHERE p.status_permintaan = 'menunggu'";
